...
server_public_ip = "http://34.227.114.2"
...
df_hotels = pd.read_json("./Visualization/hotels.json", dtype={
    "score": float,
    "province": str,
    "link": str,
    "id": int,
...
df_categories = pd.read_json("./Visualization/categories.json", dtype={
  "score_hotel": float,
  "hotel": str,
...
df_surroundings = pd.read_json("./Visualization/surroundings.json", dtype={
  "score_hotel": float,
  "hotel": str,
  "score_category": float,
  "category": str,
